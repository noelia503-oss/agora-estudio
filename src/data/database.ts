...
export interface PsychSheet { id: string; name: string; category: PsychCategory; subgroup?: string; folder?: string; image: Blob; format?: 'image' | 'pdf'; pageCount?: number; strokes: DrawingStroke[]; pageStrokes?: Record<string, DrawingStroke[]>; createdAt: string }
